...
<div style={{ textAlign: "center", margin: "32px 0" }}><img src="/img/makaleler/JWT-flow-diagram.png" alt="JWT Web Flow" style={{ width: "100%",borderRadius: "12px" }}/></div>
...
<div style={{ textAlign: "center", margin: "32px 0" }}><img src="/img/makaleler/jwt-structure.png" alt="JWT Veri Yapısı" style={{ width: "100%",borderRadius: "12px" }}/></div>
